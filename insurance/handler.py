...
class InsuranceHandler:
    ...
    # 保险公司/保险公司简称：电子标志等版式常没有"保险人名称："标签、只有分公司全名裸露在版面里，
    # 提取不到基础公司名，同车牌互补，与保司公司名称/保司地址同一批补齐
    CROSS_FILL_FIELDS = ["投保人", "被保险人", "车主", "车架号VIN", "被保险人身份证号码", "投保人身份证号码",
                         "保险公司", "保险公司简称", "保司公司名称", "保司地址", "签单日期",
    ...
    VIN_CROSS_FILL_FIELDS = ["车牌号", "投保人", "被保险人", "车主",
                             "被保险人身份证号码", "投保人身份证号码", "保险公司", "保险公司简称", "保司公司名称", "保司地址", "签单日期",
                             "厂牌型号", "发动机号", "使用性质", "机动车种类", "核定载客", "司机乘客", "车辆性质"]
